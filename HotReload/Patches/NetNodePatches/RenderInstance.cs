...
namespace HotReload.Patches.NetNodePatches {
    using Utils;

    [HarmonyPatch()]
    public static class RenderInstance {
        static void Log(string m) => HotReload.Log.Info("NetNode_RenderInstance Transpiler: " + m);
        ...
        public static IEnumerable<CodeInstruction> Transpiler(ILGenerator il, IEnumerable<CodeInstruction> instructions) {
            try {
                ...
                HotReload.Log.Error(e.ToString());
                throw e;
            }
        }
    } // end class
